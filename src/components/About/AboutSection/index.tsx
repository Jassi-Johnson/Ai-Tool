      ...
      <div className="relative mx-auto max-w-[1170px] px-4 py-20 sm:px-8 lg:py-25 xl:px-0">
        ...
        <div className="flex flex-wrap justify-between gap-11 xl:flex-nowrap">
          <div className="wow fadeInLeft w-full max-w-[570px]">
            ...
            {/* Fixed button – sage green instead of purple */}
            <a
              href="#"
              className="inline-flex rounded-lg px-7 py-3 font-medium text-white duration-300 ease-in hover:opacity-80"
              style={{
                background: "linear-gradient(180deg, #6B8A6B -11.11%, #2B4F2B 100%)",
                boxShadow: "0px -3px 10px 0px #00000040 inset",
              }}
            >
          ...
          <div className="wow fadeInRight relative hidden aspect-556/401 w-full xl:block">
            {/* Added ?v=2 to force refresh the SVG */}
            <Image src="/images/about/about.svg?v=2" alt="about" fill />
          </div>
        </div>
      </div>
    </section>
